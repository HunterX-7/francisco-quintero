import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "Designed and maintained comprehensive data models within Salesforce, implementing validation rules and establishing strategic object relationships to ensure enterprise-wide data integrity.",
        "Built and optimized workflows using Process Builder, Flow Builder, and Apex code that streamlined critical business processes.",
        "Integrated external systems with Salesforce through custom Apex classes for API connectivity, developed test classes to ensure code coverage and quality, and managed deployments by preparing and executing change sets across environments.",
        "Configured user profiles, permission sets, and sharing rules to enforce robust security protocols and appropriate data access across multiple business units, while implementing custom field-level security measures to protect sensitive information.",
        "Collaborated to gather detailed requirements and develop tailored Salesforce solutions aligned with critical business objectives, regularly conducting solution demos and integrating feedback to ensure maximum business value.",
        "Partnered with UX designers to build intuitive Lightning interfaces that enhanced user adoption and streamlined processes, incorporating progressive design principles and conducting user testing to optimize workflows and reduce training requirements.",
